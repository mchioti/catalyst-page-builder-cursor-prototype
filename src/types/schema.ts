...
export type SchemaOrgType = 
  ...
  | 'RealEstateListing'
  | 'SearchResultsPage'
  // Sub-subtypes for SoftwareApplication
  | 'MobileApplication'
  | 'VideoGame'
  | 'WebApplication'
...
export const SCHEMA_DEFINITIONS: Record<SchemaOrgType, SchemaDefinition> = {
  ...
  Comment: { type: 'Comment', label: 'Comment', description: 'Comments and responses to content', category: 'content', requiredProperties: ['text'], properties: [{ name: 'text', label: 'Comment Text', type: 'textarea', required: true }, { name: 'author', label: 'Author', type: 'text', required: false }, { name: 'dateCreated', label: 'Date Created', type: 'datetime-local', required: false }] },
  Conversation: { type: 'Conversation', label: 'Conversation', description: 'Dialogues and conversations', category: 'content', requiredProperties: ['name'], properties: [{ name: 'name', label: 'Conversation Title', type: 'text', required: true }, { name: 'description', label: 'Description', type: 'textarea', required: false }, { name: 'participant', label: 'Participants', type: 'text', required: false }] },
  DigitalDocument: { type: 'DigitalDocument', label: 'Digital Document', description: 'Electronic documents and files', category: 'content', requiredProperties: ['name'], properties: [{ name: 'name', label: 'Document Title', type: 'text', required: true }, { name: 'description', label: 'Description', type: 'textarea', required: false }, { name: 'url', label: 'Document URL', type: 'url', required: false }, { name: 'encodingFormat', label: 'File Format', type: 'text', required: false }] },
  EducationalOccupationalCredential: { type: 'EducationalOccupationalCredential', label: 'Educational Credential', description: 'Educational and occupational credentials', category: 'content', requiredProperties: ['name'], properties: [{ name: 'name', label: 'Credential Name', type: 'text', required: true }, { name: 'description', label: 'Description', type: 'textarea', required: false }, { name: 'educationalLevel', label: 'Educational Level', type: 'text', required: false }, { name: 'recognizedBy', label: 'Recognized By', type: 'text', required: false }] },
  Guide: { type: 'Guide', label: 'Guide', description: 'Guides and reference materials', category: 'content', requiredProperties: ['name'], properties: [{ name: 'name', label: 'Guide Title', type: 'text', required: true }, { name: 'description', label: 'Description', type: 'textarea', required: false }, { name: 'about', label: 'Topic/Subject', type: 'text', required: false }, { name: 'author', label: 'Author', type: 'text', required: false }] },
  HowToDirection: { type: 'HowToDirection', label: 'How-To Direction', description: 'A direction within instructions', category: 'content', requiredProperties: ['text'], properties: [{ name: 'text', label: 'Direction Text', type: 'textarea', required: true }, { name: 'position', label: 'Step Position', type: 'number', required: false }] },
  HowToSection: { type: 'HowToSection', label: 'How-To Section', description: 'A section of instructions', category: 'content', requiredProperties: ['name'], properties: [{ name: 'name', label: 'Section Title', type: 'text', required: true }, { name: 'text', label: 'Section Content', type: 'textarea', required: false }, { name: 'position', label: 'Section Position', type: 'number', required: false }] },
  HowToStep: { type: 'HowToStep', label: 'How-To Step', description: 'Individual steps in instructions', category: 'content', requiredProperties: ['text'], properties: [{ name: 'text', label: 'Step Instructions', type: 'textarea', required: true }, { name: 'name', label: 'Step Name', type: 'text', required: false }, { name: 'position', label: 'Step Number', type: 'number', required: false }] },
  HowToTip: { type: 'HowToTip', label: 'How-To Tip', description: 'Tips and hints within instructions', category: 'content', requiredProperties: ['text'], properties: [{ name: 'text', label: 'Tip Content', type: 'textarea', required: true }, { name: 'name', label: 'Tip Title', type: 'text', required: false }] },
  HyperToc: { type: 'HyperToc', label: 'Hyper Table of Contents', description: 'Hyperlinked table of contents', category: 'content', requiredProperties: ['name'], properties: [{ name: 'name', label: 'ToC Title', type: 'text', required: true }, { name: 'description', label: 'Description', type: 'textarea', required: false }] },
  HyperTocEntry: { type: 'HyperTocEntry', label: 'Hyper ToC Entry', description: 'Entry in a hyperlinked table of contents', category: 'content', requiredProperties: ['name'], properties: [{ name: 'name', label: 'Entry Title', type: 'text', required: true }, { name: 'url', label: 'Target URL', type: 'url', required: false }, { name: 'position', label: 'Position', type: 'number', required: false }] },
  LearningResource: { type: 'LearningResource', label: 'Learning Resource', description: 'Educational learning materials', category: 'content', requiredProperties: ['name'], properties: [{ name: 'name', label: 'Resource Title', type: 'text', required: true }, { name: 'description', label: 'Description', type: 'textarea', required: false }, { name: 'educationalLevel', label: 'Educational Level', type: 'text', required: false }, { name: 'learningResourceType', label: 'Resource Type', type: 'text', required: false }] },
  Manuscript: { type: 'Manuscript', label: 'Manuscript', description: 'Manuscripts and draft documents', category: 'content', requiredProperties: ['name'], properties: [{ name: 'name', label: 'Manuscript Title', type: 'text', required: true }, { name: 'description', label: 'Abstract/Description', type: 'textarea', required: false }, { name: 'author', label: 'Author', type: 'text', required: false }, { name: 'dateCreated', label: 'Date Created', type: 'date', required: false }] },
  MathSolver: { type: 'MathSolver', label: 'Math Solver', description: 'Mathematical problem solvers', category: 'content', requiredProperties: ['name'], properties: [{ name: 'name', label: 'Solver Name', type: 'text', required: true }, { name: 'description', label: 'Description', type: 'textarea', required: false }, { name: 'mathExpression', label: 'Math Expression', type: 'text', required: false }] },
  Poster: { type: 'Poster', label: 'Poster', description: 'Posters and large format displays', category: 'content', requiredProperties: ['name'], properties: [{ name: 'name', label: 'Poster Title', type: 'text', required: true }, { name: 'description', label: 'Description', type: 'textarea', required: false }, { name: 'url', label: 'Poster Image URL', type: 'url', required: false }, { name: 'author', label: 'Creator', type: 'text', required: false }] },
  Quotation: { type: 'Quotation', label: 'Quotation', description: 'Quotes and cited text', category: 'content', requiredProperties: ['text'], properties: [{ name: 'text', label: 'Quote Text', type: 'textarea', required: true }, { name: 'creator', label: 'Quoted Person/Source', type: 'text', required: false }, { name: 'dateCreated', label: 'Date of Quote', type: 'date', required: false }] },
  ShortStory: { type: 'ShortStory', label: 'Short Story', description: 'Short works of fiction', category: 'content', requiredProperties: ['name'], properties: [{ name: 'name', label: 'Story Title', type: 'text', required: true }, { name: 'description', label: 'Story Summary', type: 'textarea', required: false }, { name: 'author', label: 'Author', type: 'text', required: false }, { name: 'wordCount', label: 'Word Count', type: 'number', required: false }] },
  SoftwareSourceCode: { type: 'SoftwareSourceCode', label: 'Software Source Code', description: 'Computer source code and programming scripts', category: 'content', requiredProperties: ['name'], properties: [{ name: 'name', label: 'Code Title/Name', type: 'text', required: true }, { name: 'description', label: 'Description', type: 'textarea', required: false }, { name: 'programmingLanguage', label: 'Programming Language', type: 'text', required: false }, { name: 'codeRepository', label: 'Repository URL', type: 'url', required: false }] },
  SpecialAnnouncement: { type: 'SpecialAnnouncement', label: 'Special Announcement', description: 'Important announcements and alerts', category: 'content', requiredProperties: ['name'], properties: [{ name: 'name', label: 'Announcement Title', type: 'text', required: true }, { name: 'text', label: 'Announcement Content', type: 'textarea', required: false }, { name: 'datePosted', label: 'Date Posted', type: 'datetime-local', required: false }, { name: 'category', label: 'Category', type: 'text', required: false }] },
  Statement: { type: 'Statement', label: 'Statement', description: 'Statements and declarations', category: 'content', requiredProperties: ['text'], properties: [{ name: 'text', label: 'Statement Text', type: 'textarea', required: true }, { name: 'name', label: 'Statement Title', type: 'text', required: false }, { name: 'author', label: 'Author/Organization', type: 'text', required: false }, { name: 'dateCreated', label: 'Date Created', type: 'date', required: false }] },
  Thesis: { type: 'Thesis', label: 'Thesis', description: 'Academic theses and dissertations', category: 'content', requiredProperties: ['name'], properties: [{ name: 'name', label: 'Thesis Title', type: 'text', required: true }, { name: 'description', label: 'Abstract', type: 'textarea', required: false }, { name: 'author', label: 'Author', type: 'text', required: false }, { name: 'datePublished', label: 'Defense/Publication Date', type: 'date', required: false }, { name: 'inSupportOf', label: 'Degree', type: 'text', required: false }] },
  VisualArtwork: { type: 'VisualArtwork', label: 'Visual Artwork', description: 'Paintings, drawings, and visual art', category: 'content', requiredProperties: ['name'], properties: [{ name: 'name', label: 'Artwork Title', type: 'text', required: true }, { name: 'description', label: 'Description', type: 'textarea', required: false }, { name: 'creator', label: 'Artist', type: 'text', required: false }, { name: 'dateCreated', label: 'Date Created', type: 'date', required: false }, { name: 'medium', label: 'Medium/Materials', type: 'text', required: false }] },
  ...
  CheckoutPage: { type: 'CheckoutPage', label: 'Checkout Page', description: 'E-commerce checkout pages', category: 'content', requiredProperties: ['name'], properties: [{ name: 'name', label: 'Page Title', type: 'text', required: true }, { name: 'description', label: 'Page Description', type: 'textarea', required: false }] },
  CollectionPage: { type: 'CollectionPage', label: 'Collection Page', description: 'Pages showing collections of items', category: 'content', requiredProperties: ['name'], properties: [{ name: 'name', label: 'Collection Title', type: 'text', required: true }, { name: 'description', label: 'Collection Description', type: 'textarea', required: false }] },
  ContactPage: { type: 'ContactPage', label: 'Contact Page', description: 'Contact information pages', category: 'content', requiredProperties: ['name'], properties: [{ name: 'name', label: 'Page Title', type: 'text', required: true }, { name: 'description', label: 'Page Description', type: 'textarea', required: false }] },
  FAQPage: { type: 'FAQPage', label: 'FAQ Page', description: 'Frequently asked questions pages', category: 'content', requiredProperties: ['name'], properties: [{ name: 'name', label: 'Page Title', type: 'text', required: true }, { name: 'description', label: 'Page Description', type: 'textarea', required: false }] },
  ItemPage: { type: 'ItemPage', label: 'Item Page', description: 'Pages showing individual items', category: 'content', requiredProperties: ['name'], properties: [{ name: 'name', label: 'Item Title', type: 'text', required: true }, { name: 'description', label: 'Item Description', type: 'textarea', required: false }] },
  MedicalWebPage: { type: 'MedicalWebPage', label: 'Medical Web Page', description: 'Medical and health information pages', category: 'content', requiredProperties: ['name'], properties: [{ name: 'name', label: 'Page Title', type: 'text', required: true }, { name: 'description', label: 'Medical Content', type: 'textarea', required: false }] },
  ProfilePage: { type: 'ProfilePage', label: 'Profile Page', description: 'User or entity profile pages', category: 'content', requiredProperties: ['name'], properties: [{ name: 'name', label: 'Profile Title', type: 'text', required: true }, { name: 'description', label: 'Profile Description', type: 'textarea', required: false }] },
  QAPage: { type: 'QAPage', label: 'Q&A Page', description: 'Question and answer pages', category: 'content', requiredProperties: ['name'], properties: [{ name: 'name', label: 'Page Title', type: 'text', required: true }, { name: 'description', label: 'Page Description', type: 'textarea', required: false }] },
  RealEstateListing: { type: 'RealEstateListing', label: 'Real Estate Listing', description: 'Property listing pages', category: 'content', requiredProperties: ['name'], properties: [{ name: 'name', label: 'Property Title', type: 'text', required: true }, { name: 'description', label: 'Property Description', type: 'textarea', required: false }] },
  SearchResultsPage: { type: 'SearchResultsPage', label: 'Search Results Page', description: 'Search results display pages', category: 'content', requiredProperties: ['name'], properties: [{ name: 'name', label: 'Page Title', type: 'text', required: true }, { name: 'description', label: 'Search Context', type: 'textarea', required: false }] },

  // Sub-subtypes for SoftwareApplication
  MobileApplication: { type: 'MobileApplication', label: 'Mobile Application', description: 'Mobile apps for phones and tablets', category: 'content', requiredProperties: ['name'], properties: [{ name: 'name', label: 'App Name', type: 'text', required: true }, { name: 'description', label: 'App Description', type: 'textarea', required: false }, { name: 'operatingSystem', label: 'Operating System', type: 'text', required: false }] },
  VideoGame: { type: 'VideoGame', label: 'Video Game', description: 'Interactive games and entertainment software', category: 'content', requiredProperties: ['name'], properties: [{ name: 'name', label: 'Game Title', type: 'text', required: true }, { name: 'description', label: 'Game Description', type: 'textarea', required: false }, { name: 'genre', label: 'Game Genre', type: 'text', required: false }] },
  WebApplication: { type: 'WebApplication', label: 'Web Application', description: 'Browser-based applications', category: 'content', requiredProperties: ['name'], properties: [{ name: 'name', label: 'App Name', type: 'text', required: true }, { name: 'description', label: 'App Description', type: 'textarea', required: false }, { name: 'url', label: 'App URL', type: 'url', required: false }] },

  // Sub-subtypes for VisualArtwork
  CoverArt: { type: 'CoverArt', label: 'Cover Art', description: 'Album covers, book covers, etc.', category: 'content', requiredProperties: ['name'], properties: [{ name: 'name', label: 'Cover Title', type: 'text', required: true }, { name: 'description', label: 'Description', type: 'textarea', required: false }, { name: 'creator', label: 'Artist', type: 'text', required: false }] },
  ComicStory: { type: 'ComicStory', label: 'Comic Story', description: 'Comic books and graphic novels', category: 'content', requiredProperties: ['name'], properties: [{ name: 'name', label: 'Comic Title', type: 'text', required: true }, { name: 'description', label: 'Story Description', type: 'textarea', required: false }, { name: 'creator', label: 'Creator/Artist', type: 'text', required: false }] },
  Painting: { type: 'Painting', label: 'Painting', description: 'Painted artwork and canvases', category: 'content', requiredProperties: ['name'], properties: [{ name: 'name', label: 'Painting Title', type: 'text', required: true }, { name: 'description', label: 'Description', type: 'textarea', required: false }, { name: 'creator', label: 'Artist', type: 'text', required: false }, { name: 'medium', label: 'Paint Medium', type: 'text', required: false }] },
  Photograph: { type: 'Photograph', label: 'Photograph', description: 'Photography and photo art', category: 'content', requiredProperties: ['name'], properties: [{ name: 'name', label: 'Photo Title', type: 'text', required: true }, { name: 'description', label: 'Photo Description', type: 'textarea', required: false }, { name: 'creator', label: 'Photographer', type: 'text', required: false }, { name: 'contentUrl', label: 'Photo URL', type: 'url', required: false }] },
  Sculpture: { type: 'Sculpture', label: 'Sculpture', description: '3D artwork and sculptures', category: 'content', requiredProperties: ['name'], properties: [{ name: 'name', label: 'Sculpture Title', type: 'text', required: true }, { name: 'description', label: 'Description', type: 'textarea', required: false }, { name: 'creator', label: 'Sculptor', type: 'text', required: false }, { name: 'material', label: 'Materials', type: 'text', required: false }] },

  // Sub-subtypes for LearningResource
  Course: { type: 'Course', label: 'Course', description: 'Educational courses and classes', category: 'educational', requiredProperties: ['name'], properties: [{ name: 'name', label: 'Course Title', type: 'text', required: true }, { name: 'description', label: 'Course Description', type: 'textarea', required: false }, { name: 'instructor', label: 'Instructor', type: 'text', required: false }, { name: 'educationalLevel', label: 'Educational Level', type: 'text', required: false }, { name: 'courseCode', label: 'Course Code', type: 'text', required: false }, { name: 'numberOfCredits', label: 'Credits', type: 'number', required: false }, { name: 'coursePrerequisites', label: 'Prerequisites', type: 'textarea', required: false }] },
  Quiz: { type: 'Quiz', label: 'Quiz', description: 'Quizzes and assessments', category: 'educational', requiredProperties: ['name'], properties: [{ name: 'name', label: 'Quiz Title', type: 'text', required: true }, { name: 'description', label: 'Quiz Description', type: 'textarea', required: false }, { name: 'educationalLevel', label: 'Educational Level', type: 'text', required: false }, { name: 'about', label: 'Subject/Topic', type: 'text', required: false }, { name: 'numberOfQuestions', label: 'Number of Questions', type: 'number', required: false }, { name: 'timeRequired', label: 'Time Required', type: 'text', required: false }, { name: 'passingScore', label: 'Passing Score', type: 'text', required: false }] },
  Syllabus: { type: 'Syllabus', label: 'Syllabus', description: 'Course syllabi and curricula', category: 'educational', requiredProperties: ['name'], properties: [{ name: 'name', label: 'Syllabus Title', type: 'text', required: true }, { name: 'description', label: 'Syllabus Description', type: 'textarea', required: false }, { name: 'instructor', label: 'Instructor', type: 'text', required: false }, { name: 'educationalLevel', label: 'Educational Level', type: 'text', required: false }, { name: 'courseCode', label: 'Course Code', type: 'text', required: false }, { name: 'syllabus', label: 'Syllabus Content', type: 'textarea', required: false }, { name: 'learningObjectives', label: 'Learning Objectives', type: 'textarea', required: false }] }
}
